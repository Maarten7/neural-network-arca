...
title = 'update_three_classes_sum_tot'
...
events, labels = f['all_events'].value, f['all_labels'].value
def batches(batch_size=100):
    indices = np.random.choice(int(NUM_GOOD_EVENTS_3 * .8), size=batch_size, replace=False)
